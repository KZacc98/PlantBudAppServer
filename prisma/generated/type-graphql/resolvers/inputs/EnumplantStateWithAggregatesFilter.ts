...
import { NestedEnumplantStateWithAggregatesFilter } from "../inputs/NestedEnumplantStateWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { plantState } from "../../enums/plantState";

@TypeGraphQL.InputType("EnumplantStateWithAggregatesFilter", {
  isAbstract: true
})
export class EnumplantStateWithAggregatesFilter {
